...
namespace RayITUtilityCore31
{
    ...
    /// 產生驗證碼class
    /// </summary>
    internal sealed class ValidateCodeHelper
    {
        /// <summary>
        /// 驗證碼的最大長度
        /// </summary>
        ...
        /// <returns></returns>
        internal static string CreateValidateCode(int length)
        {
        ...
        internal static byte[] CreateValidateGraphic(string validateCode)
        {
        ...
        /// <returns></returns>
        internal static int GetImageWidth(int validateNumLength)
        {
        ...
        /// </summary>
        /// <returns></returns>
        internal static double GetImageHeight()
        {
            return 22.5;
        }
    }
